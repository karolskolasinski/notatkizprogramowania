...
Współczesny frontend stoi na jednym, potężnym fundamencie: **TypeScript**. Przekonaliśmy biznes, że dorzucenie typów do chaotycznego świata JavaScriptu to lek na całe zło. Piszemy interfejsy, konfigurujemy `tsconfig.json`, a kiedy kompilator nie krzyczy, pijemy kawę z poczuciem dobrze spełnionego obowiązku.
