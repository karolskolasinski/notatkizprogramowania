    ...
    return (
        <>
            ...
            <article className={'article article-content'}>
                ...
                <h1>Polecenia związane z użytkownikami, grupami, loginami i zamykaniem systemu</h1>
                <ul>
                ...
                <h1>Polecenia związane z katalogami</h1>
                <ul>
                ...
                <h1>Polecenia związane z plikami</h1>
                <ul>
                ...
                <h1>Polecenia związane z kopiowaniem i przenoszeniem, plików i katalogów</h1>
                <ul>
                ...
                <h1>Polecenia związane z procesami</h1>
                <ul>
                ...
                <h1>Polecenia związane z pomocą</h1>
                <ul>
                ...
                <h1>Polecenia związane z kompresją i archiwilizacją</h1>
                <ul>
