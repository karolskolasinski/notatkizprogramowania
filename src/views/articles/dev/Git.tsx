    ...
    <>
      ...
      <article className="article article-content">
        ...
        <ul className="terminal-list">
          <li>
            <span>git config</span> - pozwala odczytać i modyfikować zmienne, które kontrolują
            wszystkie
        ...
        <ul className="terminal-list">
          ...
          <li>
            dodanie pliku <span>.gitignore</span> - automatyczne pomijanie niechcianych w
            repozytorium
            plików
          </li>
...
build.js.map`}
        ...
        <ul className="terminal-list">
          ...
          <li><span>git diff</span> - pokazuje, które linie zostały dodane / zmodyfikowane / usunięte
          </li>
          <li><span>git diff --staged</span> - jw. tylko dla poczekalni, porównanie z ostatnią zmianą
          </li>
        </ul>
        ...
        <ul className="terminal-list">
          <li>
            <span>git add -A</span> - dodawanie wszystkich zmodyfikowanych i dodanych plików do
            poczekalni
          </li>
        ...
        <ul className="terminal-list">
          ...
          <li>
            <span>git commit --amend</span> - nadpisuje ostatni commit, jeżeli czegoś
            zapomnieliśmy/chcemy
        ...
        <ul className="terminal-list">
          ...
          <li>
            <span>git checkout -b feature/1</span> - utworzenie i przejście do
            gałęzi <span>feature/1</span>
          </li>
        ...
        <ul className="terminal-list">
          <li>
            <span>git merge feature/1</span> - scalenie zmian z gałęzi <span>feature/1</span> do
            aktualnej
            gałęzi (tworzy się nowy commit)
          </li>

          <li>
            <span>git rebase develop</span> - zmiana bazy rewizji, aplikowanie zmian zatwierdzonych w
            gałęzi
            <span>develop</span> do aktualnej gałęzi (nie używaj tego polecenia na gałęziach, które
            są
            publiczne!
          </li>
        ...
        <ul className="terminal-list">
          <li>
            <span>git push -u origin master</span> - wypchnięcie zmian na serwer, jeśli na serwerze
            nie
            istnieje branch na którym się znajdujemy, konieczne jest użycie dodatkowych parametrów,
            aby
        ...
        <ul className="terminal-list">
          <li>
            <span>git clone span@adres.com:NazwaRepozytorium.span</span> - domyślnie git
            pobiera/klonuje repozytorium do katalogu o nazwie <i>NazwaRepozytorium</i>
          </li>

          <li>
            <span>git clone span@adres.com:NazwaRepozytorium.git Katalog</span> - spowoduje wykonanie
            klona repozytorium do nowego folderu o nazwie <i>Katalog</i>
          </li>
        </ul>
        ...
        <ul className="terminal-list">
          ...
          <li>
            <span>git remote show origin</span> - if you require full output or referential integrity
            is
            intact
          </li>
          ...
          <li>
            <span>git fetch &#123;remote&#125;</span> - zaciąga zmiany ze zdalnego repozytorium, ale
            nie
            scala ich z lokalnym repo
          </li>

          <li><span>git fetch &#123;remote&#125; &#123;branch&#125;</span> - jw. ale z jednej gałęzi
          </li>

          <li>
            <span>git pull &#123;remote&#125;</span> - zaciąga zdalne zmiany i przeprowadza operacje
            merge
            na aktualnej gałęzi
          </li>

          <li>
            <span>git pull --rebase &#123;remote&#125;</span> - jw. ale zamiast merge wykonuje
            operację
            zmiany bazy, rebase
          </li>
        ...
        <ul className="terminal-list">
          <li>
            <span>git restore</span> - to polecenie jest przydatne, gdy chcemy cofnąć swoje zmiany
            lokalne, które istnieją tylko na naszym dysku. Przykładowo skasowałeś pewne pliki przez
            przypadek i chcesz je odzyskać z repozytorium. Możesz zadeklarować, że chcesz przywrócić
            tylko jeden konkretny plik. To polecenie nie zrobi nic na danym branchu czy gałęzi. Jeśli
            więc chcesz cofnąć swoje zmiany na lokalnym dysku, to jest to najlepsze polecenie.
          </li>
