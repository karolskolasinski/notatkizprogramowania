        ...
        <>
            ...
            <article className={'article article-content'}>
                ...
                <ul className={'terminal-list'}>
                    ...
                    <li>dodanie pliku <span>.gitignore</span> - automatyczne pomijanie niechcianych w repozytorium
                        plików
                    </li>
                    <details>
...
build.js.map`}
                ...
                <ul className={'terminal-list'}>
                    ...
                    <li><span>git checkout -b feature/1</span> - utworzenie i przejście do gałęzi <span>feature/1</span>
                    </li>
                ...
                <ul className={'terminal-list'}>
                    ...
                    <li><span>git fetch &#123;remote&#125;</span> - zaciąga zmiany ze zdalnego repozytorium, ale nie
                        scala ich z lokalnym repo
                    </li>
                    <li><span>git fetch &#123;remote&#125; &#123;branch&#125;</span> - jw. ale z jednej gałęzi</li>
                    <li><span>git pull &#123;remote&#125;</span> - zaciąga zdalne zmiany i przeprowadza operacje merge
                        na aktualnej gałęzi
                    </li>
                    <li><span>git pull --rebase &#123;remote&#125;</span> - jw. ale zamiast merge wykonuje operację
                        zmiany bazy,
                        rebase
                    </li>
