  ...
  return (
    <>
      ...
      <article className="article article-content">
        ...
        <ul className="terminal-list">
          <li>
            <span>git init</span> - stworzenie katalogu <span>.git</span>
          </li>

          <li>
            dodanie pliku <span>.gitignore</span>{" "}
            - automatyczne pomijanie niechcianych w repozytorium plików
          </li>
...
build.js.map`}
        ...
        <ul className="terminal-list">
          <li>
            <span>git status --long</span> - domyślnie
          </li>
          ...
          <li>
            <span>git status -s</span> jw.
          </li>

          <li>
            <span>git diff</span> - pokazuje, które linie zostały dodane / zmodyfikowane / usunięte
          </li>

          <li>
            <span>git diff --staged</span> - jw. tylko dla poczekalni, porównanie z ostatnią zmianą
          </li>
        </ul>
        ...
        <ul className="terminal-list">
          <li>
            <span>git add -A</span>{" "}
            - dodawanie wszystkich zmodyfikowanych i dodanych plików do poczekalni
          </li>

          <li>
            <span>git add --all</span> - jw.
          </li>

          <li>
            <span>git add .</span> - jw. ale prościej
          </li>

          <li>
            <span>git add &lt;plik&gt;</span> - dodawanie konkretnego pliku do poczekalni
          </li>

          <li>
            <span>git add *.json</span> - dodawanie wszystkich plików z rozszerzeniem .json
          </li>

          <li>
            <span>git reset HEAD &lt;plik&gt;</span> - usuwa plik z indeksu
          </li>

          <li>
            <span>git reset .</span> - usuwa wszystkie pliki z indeksu
          </li>
        </ul>
        ...
        <ul className="terminal-list">
          <li>
            <span>git commit</span> - uruchamia edytor commitów i zatwierdza zmiany
          </li>

          <li>
            <span>git commit -m "opis zmian"</span> - jw. ale prościej i szybciej
          </li>

          <li>
            <span>git commit --amend</span>{" "}
            - nadpisuje ostatni commit, jeżeli czegoś zapomnieliśmy/chcemy poprawić w ostatnim
            commit
          </li>

          <li>
            <span>git log</span> - pokazuje listę commitów, aby wyjść z <span>git log</span> wpisz
            {" "}
            <span>q</span> lub <span>z</span>
          </li>
        </ul>
        ...
        <ul className="terminal-list">
          <li>
            ...
            - wypchnięcie zmian na serwer, jeśli na serwerze nie istnieje branch na którym się
            znajdujemy, konieczne jest użycie dodatkowych parametrów, aby sprecyzować nazwę brancha
            (<span>master</span>), który ma być utworzony na serwerze (<span>
              -u origin master
            </span>)
          </li>
        </ul>
        ...
        <ul className="terminal-list">
          <li>
            <span>git clone span@adres.com:NazwaRepozytorium.span</span>{" "}
            - domyślnie git pobiera/klonuje repozytorium do katalogu o nazwie{" "}
            <i>NazwaRepozytorium</i>
          </li>

          <li>
            <span>git clone span@adres.com:NazwaRepozytorium.git Katalog</span>{" "}
            - spowoduje wykonanie klona repozytorium do nowego folderu o nazwie <i>Katalog</i>
          </li>
        </ul>
        ...
        <ul className="terminal-list">
          <li>
            <span>git remote</span> - listuje zdalne repozytoria
          </li>
          ...
          <li>
            <span>git remote set-url origin &#123;remote URL&#125;</span>{" "}
            - zmienia URL zdalnego repozytorium (origin)
          </li>

          <li>
            <span>git remote -v</span> - jw. ale pokazuje też URL
          </li>

          <li>
            <span>git fetch &#123;remote&#125;</span>{" "}
            - zaciąga zmiany ze zdalnego repozytorium, ale nie scala ich z lokalnym repo
          </li>

          <li>
            <span>git fetch &#123;remote&#125; &#123;branch&#125;</span> - jw. ale z jednej gałęzi
          </li>

          <li>
            <span>git pull &#123;remote&#125;</span>{" "}
            - zaciąga zdalne zmiany i przeprowadza operacje merge na aktualnej gałęzi
          </li>

          <li>
            <span>git pull --rebase &#123;remote&#125;</span>{" "}
            - jw. ale zamiast merge wykonuje operację zmiany bazy, rebase
          </li>
        ...
        <ul className="terminal-list">
          ...
          <li>Usunięcie ostatniego commita ze zdalnego repozytorium</li>
