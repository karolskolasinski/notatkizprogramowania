  ...
  return (
    <>
      ...
      <article className="article article-content">
        ...
        <p>
          <strong>Big O</strong> opisane jako <strong>O(T(n))</strong> składa się z dwóch części:
        </p>
        ...
        <ul>
          ...
          <li>
            opisuje on szczególnie dobrze sytuację dla dużych danych wejściowych algorytmu, ale nie
            dba o to, jak dobrze algorytm działa z wejściami o małych rozmiarach.
          </li>
        </ul>

        <p>
          W praktyce algorytm może działać nawet lepiej, niż wskazuje Big O, ale zdecydowanie nie
          gorzej.
        </p>
        ...
        <h3>O(log(n))</h3>
        <p>
          Złożoność logarytmiczna. Liczba wymaganych operacji jest proporcjonalna do logarytmu
        ...
        <h3>O(n)</h3>
        <p>
          Złożoność liniowa. Liczba wymaganych operacji jest proporcjonalna do rozmiaru danych
          ...
          znajdowanie pozycji max / min w tablicy.
        </p>

        <h3>O(n log(n))</h3>
        <p>
          Złożoność liniowo-logarytmiczna. Czas rozwiązania problemu jest wprost proporcjonalny do
