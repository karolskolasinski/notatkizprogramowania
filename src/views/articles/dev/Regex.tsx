    ...
    <>
      ...
      <article className="article article-content">
        ...
        <p>
          ...
          łańcuchów lub wyszczególniać istotne części łańcucha. Posiadają implementację w większości
        ...
        <ul className="snippet-list">
          ...
          <li><span>&#123;n&#125;</span> – dokładnie n wystąpień (np. <span>&#123;5&#125;</span>)
          </li>
        ...
        <ul className="snippet-list">
          ...
          <li>
            <span>|</span> – alternatywa (np. <span>a|s</span> → albo <b
            className="terminal">a</b> albo
          ...
          <li>
            <span>[]</span> – zbiór znaków (np. <span>\s[a-z]+\s?</span> → wszystkie małe wyrazy
            oddzielone spacją)
          </li>
        </ul>
      </article>
