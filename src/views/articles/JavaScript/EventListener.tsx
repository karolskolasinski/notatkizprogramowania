    ...
    if (event.code === "AltRight") {
        console.log(event);
                ...
                <p className='snippets'>
                    W tym kodzie napisaliśmy procedurę obsługi zdarzenia <span>keydown</span>, które powinno nastąpić po
                    naciśnięciu prawego klawisza <span className='keyboard'>Alt</span>. Aby nasz program obsługi zdarzeń
                    działał poprawnie, parametr <span>event</span> został przekazany do funkcji (czasami jest po prostu
                    ...
                    wierszy kodu będzie wyjście do konsoli informacji, które zostały przekazane do <span>event</span>.
                </p>

                <p className='snippets'>
                    JS ma właściwość <span>event.code</span>, która pozwala rozpoznać wciśnięty klawisz. Używaj:
                </p>
                <ul className='snippet-list'>
                    <li><span>event.code</span>, gdy <b>nie</b> zależy ci na wielkości liter</li>
                    ...
                    <li>
                        ...
                        <a className='article-link' href={w3Link}>World Wide Web Consortium</a>.
                    </li>
                </ul>
