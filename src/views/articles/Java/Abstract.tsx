        ...
        <table className="table">
          <tbody>
            <tr>
              <td />
              <td>
                <strong>Klasa abstrakcyjna</strong>
              </td>
              <td>
...
`}
            ...
            <p className="snippets">
              Jest to "anonimowa" implementacja{" "}
              <span>MySwingWorker</span>, gdzie (jedyna, jak z tego wynika) abstrakcyjna metoda{" "}
              <span>doInBackground</span> została zaimplementowana.
            </p>
          </details>

          <li>
            nie może istnieć klasa abstrakcyjna finalna <span>final</span>
          </li>
          ...
          <li>
            jeżeli klasy dziedziczą <span>extends</span>{" "}
            po klasie abstrakcyjnej, to klasa abstrakcyjna wymusza na nich implementację metod
            abstrakcyjnych
          </li>
        ...
        <ul className="snippet-list">
          <li>
            nie mogą posiadać pól (wyjątkiem jest pole <span>public static final</span>)
          </li>

          <li>nie ma konstruktora i nie można go stworzyć</li>

          <li>
            wszystkie metody w interfejsach są domyślnie publiczne i abstrakcyjne i nie może być
            innych
          </li>

          <li>
            metody nie posiadają ciała (wyjątkiem jest metoda <span>default</span>)
          </li>
