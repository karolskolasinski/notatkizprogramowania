        ...
        <>
            ...
            <article className={'article article-content'}>
                ...
                <div className="article-img-wrapper">
                    <img src={exceptions} alt={'jvm'} className={'article-img'} />
                </div>

                <hr />

                <h4>Wyjątki jawne (Exception)</h4>
                <ul className={'snippet-list'}>
                    <li>informują nas o potencjalnych problemach jakie mogą wystąpić przy korzystaniu z danej
                        metody
                    </li>
                    ...
                    <li>wyjątki są obiektami dlatego przy ich wywoływaniu korzystamy z standardowego
                        słówka <span>new</span></li>
                    <li>wyjątki mogą posiadać opcjonalną wiadomość</li>
                    <li>deklaracja metody musi posiadać informację o potencjalnych wyjątkach jawnych
                        np. <span>throws Exception</span></li>
                    <li>wyjątki obsługujemy poprzez ich przechwycenie, a następnie wykonanie instrukcji w
                        bloku <span>catch</span></li>
                    ...
                    <ul>
                        <li><b>IOException</b> (wyjątki po nim dziedziczące) — rzucany w przypadku problemów
                            z systemem wejścia/wyjścia, czyli najogólniej rzecz ujmując, kiedy wystąpi
                            problem przy pracy z plikami lub z transmisją danych za pośrednictwem internetu
                        </li>
                    </ul>
                </ul>
                ...
                <ul>
                    ...
                    <li>Oracle rekomenduje, aby ich nie obsługiwać i zamiast tego wypisać w logach cały
                        stacktrace zdarzenia
                    </li>
                    <ul>
                        <li><b>StackOverflowError</b> — przepełnienie stosu wywołań</li>
                        <li><b>OutOfMemoryError</b> — błąd braku pamięci</li>

                    </ul>
                </ul>
                <br />

                <h4>Wyjątki niejawne (RuntimeException)</h4>
                <ul className={'snippet-list'}>
                    <li>zdarzenia wynikające z logiki aplikacji, z którymi aplikacja nie powinna być sobie w
                        stanie poradzić, takie jak:
                    </li>
                    <ul className={'snippet-list'}>
                        <li>próba wykonania metody na pustej referencji ( <span>null</span> )
                        </li>
                    ...
                    <li>Nieobsłużony wyjątek wpadając do bloku <span>main</span> zakończy działanie
                        programu
                    </li>
                    <ul className={'snippet-list'}>
                        <li><b>NullPointerException</b> — rzucany kiedy próbujesz wywołać metodę na
                            zmiennej, której wartość to <span>null</span></li>
                        <li><b>IllegalArgumentException</b> — rzucany, kiedy przekazywany argument jest z
                            jakiegoś powodu nieprawidłowy (walidacja wewnątrz metod)
                        </li>
                        <li><b>NumberFormatException</b> — rzucany, kiedy próbujemy zamienić na liczbę np.
                            obiekt typu String, który zawiera nie tylko cyfry
                        </li>
                        <li><b>IndexOutOfBoundException</b> — rzucany, kiedy próbujemy się odwołać do
                            nieistniejącego elementu tablicy lub listy
                        </li>
                    </ul>
                </ul>

                <h4>Tworzenie własnych wyjątków</h4>
                <ul>
