            ...
            <article className={'article article-content'}>
                ...
                <ol className={'snippet-list'}>
                    <li><span>char</span> - reprezentuje litery (wielkie i małe), cyfry i inne symbole. Każdy znak to
                        ...
                        jak <span>short</span> (2 bajty = 16 bitów). Zmienne typu char mają wartości odpowiadające
                        dowolnemu znakowi kodowania UTF-16.
                    </li>
                    <li><span>boolean</span> - reprezentuje wartość typu logicznego. Może przechowywać tylko dwie
                    ...
                    <li><span>short</span> - rozmiar 16 bitów (2 bajty), zakres od -32 768 do 32 767
                    </li>
                ...
                <p>Podstawowa różnica polega na tym, że zmienna typu pierwotnego przechowuje rzeczywiste wartości,
                ...
                <p>Sposób przechowywania danych wpływa również na mechanizm przypisywania wartości zmiennej do innej
                    zmiennej:</p>
                <ul>
...
String java = language;`}
                ...
                <p>Pamiętaj tylko, że przypisując jedną wartość zmiennej referencyjnej innej, po prostu tworzymy kopię
                    referencji, a nie samą wartość.</p>
                ...
                <h1>POJO</h1>
                <p>Jest to klasa zawierająca pola oraz metody dostępowe (stery oraz getery). Należy pamiętać, że w
                    obiektach POJO nie umieszczamy logiki biznesowej.</p>

                <hr />

                <h1>Formatted output</h1>
                <p>Użycie w metodach <span className={'snippet'}>System.out.printf()</span> oraz <span
                    className={'snippet'}>String.format()</span>:</p>
