        ...
        <>
            ...
            <article className='article article-content'>
                ...
                <p className='snippets'>
                    Istnieją sytuacje, w których metody i klasy nie zależą od typów danych, na których działają. Na
                ...
                <p>
                    Typy generyczne to coś w rodzaju "szablonów". Pozwalają tworzyć klasy, które dopasowują się do
                ...
                <p className='snippets'>
                    Aby zadeklarować klasę generyczną, powinniśmy zadeklarować klasę z sekcją parametru typu z nawiasami
                    ostrymi po nazwie klasy. W poniższym przykładzie klasa <span>GenericType</span> ma pojedynczy
                    parametr typu o nazwie <span>T</span>. Zakładamy, że typ <span>T</span> jest „jakimś typem” i
                    piszemy treść klasy niezależnie od konkretnego typu.
                </p>
...
{`class GenericType<T> {
    ...
    return this.t;
                ...
                <p>
                    Aby utworzyć obiekt klasy ogólnej (standardowej lub niestandardowej), powinniśmy określić argument
                    typu po nazwie typu.
                </p>
...
GenericType<String> obj2 = new GenericType<String>("abc");`}
                ...
                <p className='snippets'>
                    Ważne jest, aby argument typu był typem referencyjnym. Nie można użyć typu pierwotnego, takiego
                    jak <span>int</span> lub <span>double</span> jako argumentu typu. Od wersji Java 7 możliwe było
                    zastąpienie argumentów typu wymaganych do wywołania konstruktora klasy ogólnej pustym zestawem
                    argumentów typu, o ile kompilator może wywnioskować argumenty typu z kontekstu.
                </p>
...
GenericType<String> obj2 = new GenericType<>("abc");`}
                ...
                <p className='snippets'>
                    Para nawiasów ostrych <span>&lt;&gt;</span> jest nieformalnie nazywana operatorem diamentowym.
                    Czasami zadeklarowanie zmiennej za pomocą typu ogólnego może być zbyt długie i słabo czytelne. Na
                    szczęście możesz napisać <span>var</span> zamiast określonego typu, aby wymusić automatyczne
                    wnioskowanie o typie na podstawie typu przypisanej wartości.
                </p>
...
{`var obj3 = new GenericType<>("abc");`}
                ...
                <p>
                    Po utworzeniu obiektu z określonym argumentem typu możemy wywołać metody klasy, które pobierają lub
                    zwracają parametr typu:
                </p>
                <pre className='line-numbers language-java'>
                    <code>
...
FuteralUniwersalny<Apple> appleFuteral = new FuteralUniwersalny<Apple>(new Apple());`}
                ...
                <p className='snippets'>
                    Jeśli zadeklarujemy pole klasy jako <span>Object</span>, możemy przypisać do niego wartość dowolnego
                    typu odwołania. To podejście było szeroko stosowane przed wersją Java 5.
                </p>
                <pre className='line-numbers language-java'>
                    <code>
{`class NonGenericClass {
    ...
    public Object get() {
        return val;
                ...
                <p className='snippets'>
                    Możliwe jest utworzenie instancji przekazującej wartość typu <span>Integer</span> lub
                    <span>Character</span>. W ten sposób możesz ponownie użyć tej samej klasy z polem
                    <span>Object</span> do przechowywania różnych typów w ten sam sposób. Po wywołaniu metody
                    <span>get()</span> otrzymujemy <span>Object</span>, a nie a <span>String</span> lub
                    <span>Integer</span>. Nie możemy pobrać stringa bezpośrednio z metody. Aby ciąg znaków, powinniśmy
                    wykonać jawne rzutowanie typu na klasę <span>String</span>.
                </p>
                <pre className='line-numbers language-java'>
                    <code>
...
String str = (String) instance2.get(); // "abc"`}
                ...
                <p className='snippets'>
                    Oczywiście to zadziała, ale co, jeśli instancja w ogóle nie przechowuje stringa? Ponieważ jest
                    zadeklarowana jako <span>Object</span>, wartość pola, może zachować dowolny typ. W takim przypadku
                    kod zgłasza wyjątek. Oto przykład:
                </p>
                <pre className='line-numbers language-java'>
                    <code>
...
String str = (String) instance3.get(); // throws java.lang.ClassCastException`}
                ...
                <p className='snippets'>
                    Teraz możemy zobaczyć główną przewagę typów generycznych nad klasą <span>Object</span> do ponownego
                    wykorzystania kodu. Nie ma potrzeby wykonywania jawnego rzutowania typu, w związku z czym nigdy nie
                    otrzymujemy wyjątku runtime. Jeśli zrobimy coś nieprawidłowo, możemy to zobaczyć w czasie
                    kompilacji.
                </p>
                <pre className='line-numbers language-java'>
                    <code>
...
Integer num = instance4.get(); // It does not compile`}
                ...
                <p className='snippets'>
                    Błąd kompilacji jest wykrywany przez programistę, a nie użytkownika programu. To sprawia, że typy
                    generyczne są zarówno elastyczne, jak i bezpieczne. Jednocześnie praca z <span>Object</span>, który
                    wymaga rzutowania typów jest podatna na błędy. Lepiej pozwolić, aby zajął się tym kompilator.
                </p>
            </article>
        </>
    );
