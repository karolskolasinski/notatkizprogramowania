    ...
    return (
        <>
            ...
            <article className='article article-content'>
                ...
                <p>
                    Klasa nie mogła by być <span>private</span>, ponieważ nie było by do niej dostępu a jej
                ...
                <p className='snippets'>
                    <span>public</span> jest najszerszym poziomem widoczności – klasy, pola i metody oznaczone w ten
                    sposób są widoczne dla wszystkich innych klas.
                </p>

                <h3>protected</h3>
                <p className='snippets'>Drugi w kolejności – <span>protected</span> – jest dostępny dla klasy
                    zdefiniowanej w tej samej paczce oraz w klasach dziedziczących (<span>extends</span>) po klasie,
                ...
                <ul className='snippet-list'>
                    ...
                    <li>
                        dostępność w innym pakiecie poprzez <span>super</span>, pod warunkiem, że klasa rozszerza główną
                        klasę ze zmienną/metodą
                    </li>
                </ul>
                ...
                <p>
                    Package, będący domyślnym poziomem widoczności nieposiadającym własnego modyfikatora, ogranicza
                    widoczność do klas z tej samej paczki.
                </p>
                <ul>
                ...
                <h3>private</h3>
                <p className='snippets'>
                    Finalnie mamy <span>private</span> – czyli prywatne. Jak sama nazwa wskazuje elementy z dostępem na
                    poziomie prywatnym są widoczne tylko dla struktur zdefiniowanych w tej samej klasie.
                </p>
