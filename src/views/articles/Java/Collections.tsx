        ...
        <>
            ...
            <article className='article article-content'>
                ...
                <ul className='snippet-list'>
                    ...
                    <li>
                        dostęp do pierwszego i ostatniego elementu listy zawsze odbywa się w stałym czasie, O(1)
                    ...
                    <li>
                        w ogólnym przypadku <span>LinkedList</span> traci do <span>ArrayList</span> w zużyciu pamięci i
                ...
                <p className='snippets'>
                    Najprostszym sposobem utworzenia listy jest wywołanie metody <span>of</span> interfejsu
                    <span>List</span>. Przed wersją Java 9 innym sposobem tworzenia niemodyfikowalnych list było
                    użycie <span>Arrays.asList(...)</span>.
                </p>
...
List<Integer> numbers = List.of(0, 1, 1, 2, 3, 5, 8, 13);  // 8 elements`}
                ...
                <p>
                    Zwraca immutable list zawierającą wszystkie przekazane elementy lub pustą listę. Użycie tej metody
...
System.out.println(weekDays); // [Monday, Tuesday, Wednesday, Thursday, Friday]`}
                ...
                <p>
                    Ponieważ jest immutable, będą działać tylko metody, które nie zmieniają elementów na liście. Inne
                    rzucą wyjątek.
                </p>
...
daysOfWeek.add("Holiday");   // throws UnsupportedOperationException`}
                ...
                <h1>Mutable lists</h1>
                <p className='snippets'>
                    Kiedy musisz użyć listy mutowalnej, możesz wziąć jedną z dwóch powszechnie używanych implementacji
                    mutowalnych interfejsu <span>List</span>.
                </p>
    ...
    public static void main(String[] args) {
        ...
        System.out.println(salutation[0][2] + salutation[1][2]);
                ...
                <ul className='snippet-list'>
                    ...
                    <li>
                        limit pojemności liczby elementów to 32 bity (2 147 483 648), ponieważ int jest indeksem -
                ...
                <ul className='snippet-list'>
                    <li>
                        <span>java.util.ArrayList</span> – najczęstszy wybór z racji najbardziej uniwersalnego
                    ...
                    <li>
                        <span>java.util.LinkedList</span> – szybsze dodawanie/usuwanie; może być traktowana jako List
                ...
                <ul className='snippet-list'>
                    ...
                    <li>
                        <span>add(E e, int index)</span> – dodaje element na wybraną pozycję (nie usuwa elementu już tam
                        się znajdującego)
                    </li>
                    ...
                    <li>
                        <span>set(E e, int index)</span> – wstawia element na wybraną pozycję (tym samym poprzednio
                        znajdujący się element zostaje usunięty)
                    </li>

                    <li><span>get(int index)</span> – zwraca element o wybranym indeksie</li>
                    <li>
                        <span>addAll(Collection)</span> – dodaje wszystkie elementy z jednej kolekcji do drugiej i
                    ...
                    <li>
                        <span>indexOf(E e)</span> – wyszukuje element na liście i zwraca pierwszy indeks wystąpienia
                    </li>
...
System.out.println(ulubione.indexOf("Commodore 64"));`}
                ...
                <ul className='snippet-list'>
                    <li>
                        kolejność nie ma znaczenia (nie pozwala na bezpośredni dostęp do obiektu poprzez podanie np.
                        indeksu)
                    </li>

                    <li>
                        przechowuje elementy unikalne - ten sam obiekt może znajdować się w zbiorze tylko raz (nie
                    ...
                    <li>
                        aby dostać się do obiektu musimy skorzystać z pętli <span>foreach</span> lub specjalnego
                ...
                <ul className='snippet-list'>
                    <li>
                        <span>java.util.HashSet</span> – najczęściej występująca – dobra wydajnościowo; brak zachowania
                        kolejności
                    </li>

                    <li>
                        <span>java.util.TreeSet</span> – umieszcza nowe elementy kolekcji poprzez użycie
                        <span>Comparatora</span>; wszystkie elementy od razu posortowane i zachowują swoją kolejność.
                        Implementacja oparta o drzewa czerwono czarne, która oprócz unikalności elementów gwarantuje nam
                        uporządkowanie wstawianych elementów zgodnie z naturalnym porządkiem. Porządek ten wyznaczany
                        jest poprzez implementację interfejsu <span>Comparable</span> lub zastosowanie odpowiedniego
                        <span>Comparatora</span> (oznacza to, że elementy w zbiorze muszą implementować interfejs
                        <span>Comparable</span> lub trzeba dostarczyć <span>Comparator</span>.
                    </li>
                ...
                <ul className='snippet-list'>
                    ...
                    <li>
                        <span>remove(E e)</span> – usuwa wybrany element po wartości, ponieważ <span>Set</span> nie ma
                        indeksów
                    </li>
                    ...
                    <li>
                        <span>iterator()</span> – zwraca obiekt typu <span>Iterator</span> umożliwiający iterowanie
                        zbioru
                    </li>

                    <li>
                        Ze względu na brak zachowania kolejności zbiór nie posiada metod takich jak <span>get</span>,
                        <span>indexOf</span>, <span>lastIndexOf</span>. Zamiast tego posiada metody:
                    </li>

                    <ul className='nested-list'>
                        <li>
                            <span>contains(E e)</span> – zwraca <span>true</span> jeśli element znajduje się w zbiorze
                        </li>
...
for (String imie: imiona) {
    System.out.println(imie);
                ...
                <ul>
                    ...
                    <li>
                        w odróżnieniu od indeksu w liście (gdzie wymaga się liczb całkowitych), kluczem może być inny
                ...
                <ul className='snippet-list'>
                    <li>
                        <span>java.util.HashMap</span> – najczęściej występująca – dobra wydajnościowo; brak zachowania
                        kolejności
                    </li>

                    <li>
                        <span>java.util.LinkedHashMap</span> – zachowuje kolejność wpisywanych elementów (jak w Liście)
                    </li>

                    <li>
                        <span>java.util.TreeMap</span> – umieszcza nowe elementy kolekcji poprzez
                ...
                <ul className='snippet-list'>
                    <li>
                        <span>put(Key key, Value value)</span> – umieszcza nową parę klucz: wartość w mapie(lub
                    ...
                    <li>
                        <span>containsKey(Object o)</span> – zwraca <span>true</span> jeśli mapa zawiera wskazany klucz
                    </li>

                    <li>
                        <span>containsValue(Object o)</span> – zwraca <span>true</span> jeśli mapa zawiera wskazaną
                        wartość
                    </li>
...
for (java.util.Map.Entry para: procesory.entrySet()) {
    ...
    System.out.println(para.getValue());
                ...
                <ul className='snippet-list'>
                    <li>
                        <span>java.util.ArrayDeque</span> — kolejka oparta o tablice, pozwala na dostęp zarówno od
                        strony głowy <span>getFirst()</span> jak i ogona <span>getLast()</span>. Elementy przechowywane
                        są w kolejności dodawania
                    </li>
                    <li>
                        <span>java.util.PriorityQueue</span> – pozwala na przechowywanie i dostęp do elementów wg
                ...
                <ul className='snippet-list'>
                    <li>
                        <span>boolean offer(E e)</span> wstawia określony element do kolejki, jeśli jest to możliwe od
                        razu bez naruszania ograniczeń pojemności; zwraca <span>true</span> / <span>false</span> w
                        zależności od wyniku tej operacji
                    </li>

                    <li>
                        <span>E remove()</span> pobiera i usuwa head tej kolejki; jeśli jest pusty, metoda
                        rzuca <span>NoSuchElementException</span>
                    </li>

                    <li>
                        <span>E poll()</span> pobiera i usuwa head tej kolejki lub zwraca <span>null</span> jeśli ta
                        kolejka jest pusta
                    </li>

                    <li>
                        <span>E element()</span> pobiera, ale nie usuwa head kolejki; jeśli jest pusty, metoda rzuca
                        <span>NoSuchElementException</span>
                    </li>

                    <li>
                        <span>E peek()</span> pobiera, ale nie usuwa head tej kolejki lub zwraca <span>null</span> jeśli
                        ta kolejka jest pusta
                    </li>

                    <li>
                        <span>add(E element)</span> metoda działa tak samo jak <span>offer(E e)</span> ale
