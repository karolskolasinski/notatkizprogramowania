    ...
    return (
        <>
            ...
            <article className='article article-content'>
                ...
                <a href='https://www.w3schools.com/tags/' className='article-link'>https://www.w3schools.com/tags/</a>
                ...
                <p>
                    ...
                    tagi HTML składają się tylko z tagów początkowych.
                </p>
                ...
                <ul className='snippet-list'>
                    ...
                    <li>
                        <span>&lt;figure&gt;</span> Groups media content with a caption
                ...
                <p className='snippets'>
                    ...
                    <span>&lt;a&gt;</span>, który może również zawierać elementy blokowe. Przeglądarka nie przerywa
                    linii przed i po tagu. Elementy wbudowane są ściśle zawarte w tagach.
                </p>

                <ul className='snippet-list'>
                    <li>
                        <span>&lt;a&gt;</span> jest prawdopodobnie jednym z najważniejszych elementów HTML. Jest
                        przeznaczony do tworzenia linków. Ten znacznik jest często używany z atrybutem
                        <span>href</span>, który wskazuje ścieżkę do pliku / strony internetowej, do której się
                        odwołuje. Tekst zawinięty w tym tagu jest podkreślony i wyróżniony kolorem. Po kliknięciu
                        zostaniesz przeniesiony pod adres określony w atrybucie <span>href</span>.
                    </li>
                    ...
                    <li>
                        <span>&lt;b&gt;</span> ten sparowany tag ustawia pogrubioną czcionkę dla każdego zawartego w nim
                        tekstu.
                    </li>
...
{`img {
    display: block;
                    ...
                    <li>
                        <span>&lt;span&gt;</span> w tym sparowanym tagu możesz zawijać tekst lub jego część. Ten tag w
                    ...
                    <li>
                        <span>&lt;sub&gt;</span> ten znacznik służy do tworzenia tekstu indeksu dolnego: to znaczy, że
                    ...
                    <li>
                        <span>&lt;sup&gt;</span> ten tag definiuje tekst w indeksie górnym. Jest podobny do
