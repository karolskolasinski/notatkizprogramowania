    ...
    return (
        <>
            ...
            <article className='article article-content'>
                ...
                <p>
                    Celem resetowania arkusza stylów jest zmniejszenie niespójności przeglądarki w takich kwestiach, jak
                    domyślne wysokości linii, marginesy i rozmiary czcionek nagłówków i tak dalej. Resetowanie stylów
                    dość często pojawia się we frameworkach CSS. Istnieją różne resety CSS, najczęściej bazują na <a
                    href='https://meyerweb.com/eric/tools/css/reset/' className='article-link'> CSS Tools: Reset CSS</a>
                </p>
...
img {
    display: block;
                ...
                <h1>Normalize CSS</h1>
                <p>
                    Każda przeglądarka posiada własne, domyślne style, dlatego wygląd strony z tym samym CSS może się
                    różnić. Rozwiązaniem może być <a href='https://github.com/necolas/normalize.css/'
